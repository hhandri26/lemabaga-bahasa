...
export class DetailsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._referensiInstansiService.items$
    ...
    update(): void {
        ...
        this._referensiInstansiService.save(params).subscribe(
            (result) => {
                if (result?.success) {
                    this._toastr.success('Referensi instansi berhasil diperbaharui', 'Update berhasil');
                    this.form.reset();
    ...
    delete(): void {
        ...
        this._referensiInstansiService.delete(id)
            .subscribe((result: any) => {
                if (result?.success) {
                    this._toastr.success('Referensi instansi berhasil dihapus', 'Hapus berhasil');
                    if (nexttId) {
