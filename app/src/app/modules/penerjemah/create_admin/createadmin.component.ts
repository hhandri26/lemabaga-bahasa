...
export class CreateComponentAdmin implements OnInit, OnDestroy {
    isLoading = false;
    form: FormGroup;
    ...
    constructor(
        public matDialogRef: MatDialogRef<CreateComponentAdmin>,
    ...
    create(): void {
        ...
        //     nama: params.nama,
        //     nip: params.nip,
        //     tempatLahirId: params.tempatLahirId.id,
        //     tglLahir: moment(params.tglLahir).format('DD-MM-YYYY'),
        //     jenisKelamin: params.jenisKelamin,
        //     golonganId: params.golonganId,
        //     jabatanId: params.jabatanId,
        //     unitKerjaId: params.unitKerjaId.id,
        //     tmtJabatan: moment(params.tmtJabatan).format('DD-MM-YYYY'),
        //     tmtGolongan: moment(params.tmtGolongan).format('DD-MM-YYYY')
        // };
        ...
        this._penerjemahService.saveDataUtamaAdmin(formData).subscribe(
            (result) => {
                if (result?.success) {
                    this._toastr.success('PFP berhasil ditambahkan, password akan dikirimkan melalui email', 'Tambah pengguna berhasil');
                    this.form.reset();
