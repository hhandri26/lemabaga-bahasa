...
export class AngkaKreditComponent implements OnInit, OnDestroy {
    ...
    loadData() {
        this._penerjemahService.jfpItem$
            ...
            .subscribe((item: any) => {
                this.pnsId = item.id;
                this._penerjemahService.getRwAngkaKredit(item.id).subscribe();
    ...
    insert(): void {
        ...
        if (formInput.nilaiAk) { body.append('nilaiAk', formInput.nilaiAk); }
        if (formInput.nilaiSkp) { body.append('nilaiSkp', formInput.nilaiSkp); }
        ...
        this._penerjemahService.saveRwAngkaKredit(body).subscribe(
            (result) => {
                if (result?.success) {
    ...
    delete(): void {
        this._penerjemahService.deleteAngkaKredit(this.selected.id).subscribe(
            (result) => {
                if (result?.success) {
