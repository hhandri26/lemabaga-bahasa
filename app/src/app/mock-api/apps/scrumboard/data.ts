...
export const boards = [
    ...
    description: "Tugas-tugas dan kegiatan instansi pemerintah",
    icon: "<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' fill='currentColor' viewBox='0 0 24 24'><path d='M12 2l10 7v13a1 1 0 01-1 1H3a1 1 0 01-1-1V9l10-7zm0 2.15L5 9v11h14V9l-7-4.85zm-1 6.85v5h2v-5h-2zm0-4v2h2V7h-2z'/></svg>",
