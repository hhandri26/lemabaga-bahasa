...
export class DetailsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._referensiPelatihanService.items$
    ...
    update(): void {
        ...
        this._referensiPelatihanService.save(params).subscribe(
            (result) => {
                if (result?.success) {
                    this._toastr.success('Referensi pelatihan berhasil diperbaharui', 'Update berhasil');
                    this.form.reset();
    ...
    delete(): void {
        ...
        this._referensiPelatihanService.delete(id)
            .subscribe((result: any) => {
                if (result?.success) {
                    this._toastr.success('Referensi pelatihan berhasil dihapus', 'Hapus berhasil');
                    if (nexttId) {
    ...
    displayPelatihanFn(item: { nama: string; jenis: string }) {
