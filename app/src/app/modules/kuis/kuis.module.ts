...
import { DetailResolver, ListResolver } from './kuis.resolvers';
import { DetailsComponent } from './details/details.component';
import { CanDeactivateDetails } from './kuis.guards';
...
@NgModule({
  declarations: [
    KuisComponent, DetailsComponent, ListComponent, CreateComponent
  ],
  imports: [
