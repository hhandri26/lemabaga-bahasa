...
export class ListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.items$ = this._referensiJenisSertifikatService.items$;
        ...
        this._referensiJenisSertifikatService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
    ...
    fetch(pageIndex, pageSize) {
        return this._referensiJenisSertifikatService.getList(pageIndex, pageSize).pipe();
    }
