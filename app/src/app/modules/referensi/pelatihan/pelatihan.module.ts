...
import { DetailResolver, ListResolver } from './pelatihan.resolvers';
import { DetailsComponent } from './details/details.component';
import { CanDeactivateDetails } from './pelatihan.guards';
...
@NgModule({
  declarations: [
    PelatihanComponent, DetailsComponent, ListComponent, CreateComponent
  ],
  imports: [
