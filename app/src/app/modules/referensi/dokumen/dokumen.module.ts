...
import { DetailResolver, ListResolver } from './dokumen.resolvers';
import { DetailsComponent } from './details/details.component';
import { CanDeactivateDetails } from './dokumen.guards';
...
@NgModule({
  declarations: [
    DokumenComponent, DetailsComponent, ListComponent, CreateComponent
  ],
  imports: [
