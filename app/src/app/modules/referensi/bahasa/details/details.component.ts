...
export class DetailsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._referensiBahasaService.items$
    ...
    update(): void {
        ...
        this._referensiBahasaService.save(params).subscribe(
            (result) => {
                if (result?.success) {
                    this._toastr.success('Referensi bahasa berhasil diperbaharui', 'Update berhasil');
                    this.form.reset();
    ...
    delete(): void {
        ...
        this._referensiBahasaService.delete(id)
            .subscribe((result: any) => {
                if (result?.success) {
                    this._toastr.success('Referensi bahasa berhasil dihapus', 'Hapus berhasil');
                    if (nexttId) {
