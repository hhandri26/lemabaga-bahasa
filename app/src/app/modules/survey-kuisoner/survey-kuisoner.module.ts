...
import { SurveyKuisonerComponent } from './survey-kuisoner.component';
...
@NgModule({
    ...
    imports: [
        RouterModule.forChild([
            {
                path: '',
                component: SurveyKuisonerComponent,
                // resolve: {
...
export class SurveyKuisonerModule { }
