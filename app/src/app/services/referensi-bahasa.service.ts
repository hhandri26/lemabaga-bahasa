...
export class ReferensiBahasaService {
    ...
    getList(params = { q: '' }, draw: number = 0, perPage: number = 10):
        ...
        return this._httpClient.get<{ pagination: any; items: any[] }>(this._apiUrl + '/refference/bahasa', { params }).pipe(
            tap((response: any) => {
    ...
    save(params): Observable<any> {
        return this._httpClient.post<any>(this._apiUrl + '/write-reff/bahasa/save', params).pipe(
    ...
    delete(id: string): Observable<boolean> {
        return this.items$.pipe(
            take(1),
            switchMap(items => this._httpClient.delete(this._apiUrl + '/write-reff/bahasa/delete/' + id).pipe(
