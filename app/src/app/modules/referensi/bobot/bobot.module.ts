...
import { DetailResolver, ListResolver } from './bobot.resolvers';
import { DetailsComponent } from './details/details.component';
import { CanDeactivateDetails } from './bobot.guards';
...
@NgModule({
  declarations: [
    BobotComponent, DetailsComponent, ListComponent, CreateComponent
  ],
  imports: [
