...
export const categories = [
    {
        ...
        title: 'Kegiatan Penerjemah',
        slug : 'KEGIATAN_PENERJEMAH'
    },
    {
...
export const courses = [
    ...
    {
        id         : 'f924007a',
        title      : 'Aplikasi Translate Online',
    ...
    {
        id         : '0c06e980',
        title      : 'Penerjemahan Teks Jurnalistik Angkatan I Tahun 2021',
        slug       : 'android-n-quick-settings',
        description: 'Pemerintah melalui Kementerian Ketenagakerjaan (Kemnaker) telah menyalurkan Bantuan Subsidi Upah (BSU) tahap pertama kepada para pekerja yang memenuhi syarat serta telah lolos verifikasi maupun validasi. Bantuan ini diberikan kepada pekerja atau buruh untuk mempertahankan daya beli pekerja atau buruh dalam memenuhi kebutuhan hidupnya sebagai akibat dari kenaikan harga',
        category   : 'KEGIATAN_PENERJEMAH',
        comment   : 120,
        poster: 'forum_3.jpg',
        vote   : 24,
        tanggal   : '11-12-2022',
