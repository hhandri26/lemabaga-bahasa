...
export class CreateComponent implements OnInit, OnDestroy {
    form: FormGroup;
    kegiatanTranslasiList = this._referensiService.kegiatanTranslasiList();
    ...
    ngOnInit(): void {
        this.form = this._formBuilder.group({
            tipeKegiatan: ['', [Validators.required]],
    ...
    create(): void {
        ...
        this._referensiKegiatanTranslasiService.save(params).subscribe(
            (result) => {
                if (result?.success) {
                    this._toastr.success('Referensi pendidikan berhasil ditambahkan', 'Tambah referensi pendidikan berhasil');
                    this.form.reset();
