...
export class ListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.items$ = this._referensiDiklatTopikService.items$;
        ...
        this._referensiDiklatTopikService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
    ...
    fetch(pageIndex, pageSize) {
        return this._referensiDiklatTopikService.getList(pageIndex, pageSize).pipe();
    }
