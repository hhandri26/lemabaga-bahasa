...
import { DetailResolver, ListResolver } from './pendidikan.resolvers';
import { DetailsComponent } from './details/details.component';
import { CanDeactivateDetails } from './pendidikan.guards';
...
@NgModule({
  declarations: [
    PendidikanComponent, DetailsComponent, ListComponent, CreateComponent
  ],
  imports: [
