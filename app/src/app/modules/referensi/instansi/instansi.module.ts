...
import { DetailResolver, ListResolver } from './instansi.resolvers';
import { DetailsComponent } from './details/details.component';
import { CanDeactivateDetails } from './instansi.guards';
...
@NgModule({
  declarations: [
    InstansiComponent, DetailsComponent, ListComponent, CreateComponent
  ],
  imports: [
