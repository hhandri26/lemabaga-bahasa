...
export class DetailsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._referensiJenisSertifikatService.items$
        ...
        this._referensiJenisSertifikatService.item$
            .pipe(takeUntil(this._unsubscribeAll))
    ...
    update(): void {
        ...
        this._referensiJenisSertifikatService.save(params).subscribe(
            (result) => {
                if (result?.success) {
                    this._toastr.success('Referensi jenis sertifikat berhasil diperbaharui', 'Update berhasil');
                    this.form.reset();
                    this._router.navigate(['../'], { relativeTo: this._activatedRoute });
                    this._referensiJenisSertifikatService.getList().subscribe();
                } else {
    ...
    delete(): void {
        ...
        this._referensiJenisSertifikatService.delete(id)
            .subscribe((result: any) => {
                if (result?.success) {
                    this._toastr.success('Referensi jenis sertifikat berhasil dihapus', 'Hapus berhasil');
                    if (nexttId) {
