...
export class ListRespondenComponentKuisoner implements OnInit, OnDestroy {
    ...
    constructor(
        public matDialogRef: MatDialogRef<ListRespondenComponentKuisoner>,
    ...
    ngOnInit(): void {
        ...
        this._surveyKuisonerService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
