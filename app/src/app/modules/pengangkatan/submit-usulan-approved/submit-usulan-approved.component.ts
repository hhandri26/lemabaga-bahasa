...
@Component({
    templateUrl: './submit-usulan-approved.component.html',
...
export class SubmitUsulanApprovedComponent implements OnInit, OnDestroy {
    form: FormGroup;
    onFileInputed: boolean = false;
    private _unsubscribeAll: Subject<any> = new Subject<any>();

    constructor(
        public matDialogRef: MatDialogRef<SubmitUsulanApprovedComponent>,
    ...
    approved(): void {
        ...
        this._pengangkatanService.sendRekomendasi(body).subscribe(
            (result) => {
                if (result?.success) {
                    this._toastr.success('Rekomendasi berhasil disubmit, selanjutnya menunggu SK Pengangkatan oleh Kepegawaian');
                    this.form.reset();
