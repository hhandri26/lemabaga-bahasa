...
export class UjiBerbahasaComponent implements OnInit, OnDestroy {
    ...
    form: FormGroup;
    jenisSertifikat$: Observable<any[]> = this._referensiService.jenisSertifikat();
    ...
    loadData() {
        this._penerjemahService.jfpItem$
            ...
            .subscribe((item: any) => {
                this.pnsId = item.id;
                this._penerjemahService.getRwUjiKemahiranBerbahasa(item.id).subscribe();
    ...
    insert(): void {
        ...
        if (formInput.jenisSertifikat) { body.append('jenisSertifikat', formInput.jenisSertifikat); }
    ...
    toggleDetails(id: string): void {
        ...
        this._penerjemahService.getRwUjiKemahiranBerbahasaById(id)
            .subscribe((item) => {
                this.selected = item;
                this.form.patchValue(item);
                this.form.get('jenisSertifikat').setValue(item.jenisSertifikat.id);
                this._changeDetectorRef.markForCheck();
            });
    }
