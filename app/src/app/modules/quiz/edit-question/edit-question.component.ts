...
@Component({
    selector: 'quiz-edit-question',
    templateUrl: './edit-question.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class QuizEditQuestionComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _matDialogRef: MatDialogRef<QuizEditQuestionComponent>
    ) {
    }
    ...
    save(): void {
        ...
        this._quizService.editQuestion(params).subscribe(
            (result) => {
                if (result?.success) {
                    ...
                    this._quizService.detail(this._data.bucket.id).subscribe();
