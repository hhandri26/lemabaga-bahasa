...
export class ListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.items$ = this._referensiDiklatGroupService.items$;
        ...
        this._referensiDiklatGroupService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
    ...
    fetch(pageIndex, pageSize) {
        return this._referensiDiklatGroupService.getList(pageIndex, pageSize).pipe();
    }
