...
export class ListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.items$ = this._referensiInstansiService.items$;

        this._referensiInstansiService.item$
        ...
        this._referensiInstansiService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
        ...
        fromEvent(this.findKeyword.nativeElement, 'keyup')
            .pipe(
                ...
                tap(() => {
                    ...
                    this._changeDetectorRef.markForCheck();
                    this._referensiInstansiService.getList({q: (this.findKeyword.nativeElement.value) ? this.findKeyword.nativeElement.value : ''}, this.draw, this.perPage).subscribe();
                })
            )
            .subscribe();
    ...
    fetch(pageIndex, pageSize) {
        return this._referensiInstansiService.getList({q: (this.findKeyword.nativeElement.value) ? this.findKeyword.nativeElement.value : ''}, pageIndex, pageSize).pipe();
    }
