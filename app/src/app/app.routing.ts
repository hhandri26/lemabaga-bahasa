...
export const appRoutes: Route[] = [
    ...
    // Auth routes for guests
    {
        ...
        children: [
            ...
            {path: 'survey-publik', loadChildren: () => import('app/modules/survey-publik/survey-publik.module').then(m => m.SurveyPublikModule)},
            {path: 'survey-publik-end', loadChildren: () => import('app/modules/survey-publik/end/end.module').then(m => m.SurveyPublikEndModule)},
        ]
    },
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            { path: 'survey-daftar-hadir', loadChildren: () => import('app/modules/survey-daftar-hadir/survey-daftar-hadir.module').then(m => m.SurveyDaftarHadirModule) },
