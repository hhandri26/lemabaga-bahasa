...
export class CreateComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngOnInit(): void {
        this.form = this._formBuilder.group({
            id: [''],
            jenisKegiatan: [null, [Validators.required]],
            judul: [null, [Validators.required]],
            deskripsi: ['', [Validators.required]],
            lokasi: [null, [Validators.required]],
            tglMulai: [null, [Validators.required]],
            tglAkhir: [null, [Validators.required]],
            deadlineKonfirmasi: [null, [Validators.required]],
            deadline_time: [null, [Validators.required]],
            isForAllJFP: [false],
