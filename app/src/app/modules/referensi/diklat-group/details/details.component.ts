...
export class DetailsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._referensiDiklatGroupService.items$
        ...
        this._referensiDiklatGroupService.item$
            .pipe(takeUntil(this._unsubscribeAll))
    ...
    update(): void {
        ...
        params.groupId = this.selected.id;
        this._referensiDiklatGroupService.save(params).subscribe(
            (result) => {
                if (result?.success) {
                    this._toastr.success('Referensi group diklat berhasil diperbaharui', 'Update berhasil');
                    this.form.reset();
                    this._router.navigate(['../'], { relativeTo: this._activatedRoute });
                    this._referensiDiklatGroupService.getList().subscribe();
                } else {
    ...
    delete(): void {
        ...
        this._referensiDiklatGroupService.delete(id)
            .subscribe((result: any) => {
                if (result?.success) {
                    this._toastr.success('Referensi group diklat berhasil dihapus', 'Hapus berhasil');
                    if (nexttId) {
