...
import { VerifikasiRiwayatComponent } from './verifikasi-riwayat.component';
...
@NgModule({
    declarations: [
        VerifikasiRiwayatComponent,
        ListComponent,
        KoreksiKakComponent,
        CetakKakComponent,
        ProsesUlangKakComponent
    ],
    imports: [
        CommonModule,
        RouterModule.forChild([
            {
                path: '',
                component: VerifikasiRiwayatComponent,
                children: [
                    {
                        path: '',
...
export class VerifikasiRiwayatModule { }
