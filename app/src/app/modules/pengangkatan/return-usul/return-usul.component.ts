...
@Component({
    templateUrl: './return-usul.component.html',
...
export class ReturnUsulComponent implements OnInit, OnDestroy {
    form: FormGroup;
    private _unsubscribeAll: Subject<any> = new Subject<any>();

    constructor(
        public matDialogRef: MatDialogRef<ReturnUsulComponent>,
    ...
    send(): void {
        ...
        this._pengangkatanService.returnUsulan(body).subscribe(
            (result) => {
                if (result?.success) {
                    this._toastr.success('Penolakan usulan formasi berhasil');
                    this.form.reset();
