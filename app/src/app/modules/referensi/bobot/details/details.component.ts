...
export class DetailsComponent implements OnInit, OnDestroy {
    ...
    selected: any;
    items: any[];
    klasifikasiBototList = this._referensiService.klasifikasiBototList();
    ...
    ngOnInit(): void {
        ...
        this.form = this._formBuilder.group({
            id: [''],
            sebutan: ['', [Validators.required]],
            fromNilai: ['', [Validators.required]],
            toNilai: ['', [Validators.required]],
            persentase: ['', [Validators.required]],
            status: [true, [Validators.required]],
        });

        this._referensiBobotService.items$
        ...
        this._referensiBobotService.item$
            .pipe(takeUntil(this._unsubscribeAll))
    ...
    update(): void {
        ...
        this._referensiBobotService.save(params).subscribe(
            (result) => {
                if (result?.success) {
                    this._toastr.success('Referensi pendidikan berhasil diperbaharui', 'Update berhasil');
                    this.form.reset();
                    this._router.navigate(['../'], { relativeTo: this._activatedRoute });
                    this._referensiBobotService.getList().subscribe();
                } else {
    ...
    delete(): void {
        ...
        this._referensiBobotService.delete(id)
